"""Directory scanning and indexing logic."""
...
def scan_directory(dir_path: Path) -> Iterator[Path]:
    """Recursively scan a directory for supported document files, skipping hidden paths."""
...
def get_files_to_index(
    ...
    for file_path in scan_directory(dir_path):
...
def index_directory(
    ...
    with open_database(db_path) as conn:
        ...
        files_to_index, paths_to_delete = get_files_to_index(
            dir_path, existing_mtimes, update_only
        )
        ...
        for i, file_path in enumerate(files_to_index):
            ...
            try:
                ...
                embeddings = get_embeddings_batch(doc.chunks)
